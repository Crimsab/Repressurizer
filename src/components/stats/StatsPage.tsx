          ...
          {Object.values(statuses).length > 0 && (
            <div>
              ...
              <div className="flex gap-2 flex-wrap">
                {[
                  { key: "playing",   label: t("status.playing"),   color: "text-sky-400",      bg: "bg-sky-400/15" },
                  { key: "beaten",    label: t("status.beaten"),    color: "text-violet-400",   bg: "bg-violet-400/15" },
                  { key: "completed", label: t("status.completed"), color: "text-repressurizer-accent", bg: "bg-repressurizer-accent/15" },
                  { key: "abandoned", label: t("status.abandoned"), color: "text-repressurizer-text-faint", bg: "bg-repressurizer-surface-hover" },
              ...
              <div className="rounded-xl bg-repressurizer-bg border border-repressurizer-border-subtle px-4 py-3 space-y-3">
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-repressurizer-text-faint mt-0.5">
                    {achievementStats.completionPercent}% {t("sort.hint.achievements")}
                  </p>
                </div>
